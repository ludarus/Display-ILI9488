...
int main(void)
{
  ...
  CAN_CMDS_Init(&hcan, &hspi1, &huart2, &htim14, &htim17, BAUD_INPUT1_GPIO_Port,
                BAUD_INPUT1_Pin, BAUD_INPUT2_GPIO_Port, BAUD_INPUT2_Pin,
                BAUD_INPUT3_GPIO_Port, BAUD_INPUT3_Pin);
...
static void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pins : BAUD_INPUT3_Pin BAUD_INPUT2_Pin BAUD_INPUT1_Pin SWITCH5_Pin
                           SWITCH4_Pin */
  GPIO_InitStruct.Pin = BAUD_INPUT3_Pin|BAUD_INPUT2_Pin|BAUD_INPUT1_Pin|SWITCH5_Pin
                          |SWITCH4_Pin;
